...
class Model(object):
    ...
    def __init__(self,
        ...
        value_prediction_clipped = oldvpred_ + \
            tf.clip_by_value(train_model.vf - oldvpred_,  -
                             cliprange_, cliprange_)
        ...
        pg_loss_clipped = -advantages_ * \
            tf.clip_by_value(ratio, 1.0 - cliprange_, 1.0 + cliprange_)
...
def learn(policy,
    ...
    # For instance if we take 5 steps and we have 5 environments batch_size = 25
        ...
        for _ in range(noptepochs):
            ...
            for start in range(0, batch_size, batch_train_size):
                ...
                slices = (arr[mbinds] for arr in (
                    obs, actions, returns, values, neglogpacs))
